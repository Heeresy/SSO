...
func (x *IsAdminRequest) GetToken() int64 {
	if x != nil {
		return x.Token
	}
	return 0
...
const file_sso_proto_rawDesc = "" +
	...
	"\aisAdmin\x18\x01 \x01(\bR\aisAdmin2\xa5\x01\n" +
	"\x04Auth\x12.\n" +
	"\x05Login\x12\x11.sso.LoginRequest\x1a\x12.sso.LoginResponse\x127\n" +
	"\bRegister\x12\x14.sso.RegisterRequest\x1a\x15.sso.RegisterResponse\x124\n" +
	"\aIsAdmin\x12\x13.sso.IsAdminRequest\x1a\x14.sso.IsAdminResponseB\x0fZ\rgRpcTuzov/ssob\x06proto3"
